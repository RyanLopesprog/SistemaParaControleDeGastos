...
public class TelaCadastro extends JFrame {
	...
	public TelaCadastro() {
		...
		lbl_cpf_cadastro.setBounds(10, 138, 73, 14);
		contentPane.add(lbl_cpf_cadastro);
		
		txt_cpf_cadastro = new JTextField();
		txt_cpf_cadastro.setBounds(10, 163, 130, 20);
		...
		lbl_senha_cadastro.setBounds(10, 200, 73, 14);
		contentPane.add(lbl_senha_cadastro);
		
		txt_senha_cadastro = new JTextField();
		txt_senha_cadastro.setBounds(10, 225, 130, 20);
		...
		btn_cadastro.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Usuario usuario = new Usuario(1, txt_nome_cadastro.getText(),txt_cpf_cadastro.getText(), txt_senha_cadastro.getText());
