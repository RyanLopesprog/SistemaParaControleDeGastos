	...
	public static void inicializar() {
		try {
			...
			String createTableusuarios = "CREATE TABLE IF NOT EXISTS usuarios ("
					+ "id_usuario INT NOT NULL AUTO_INCREMENT PRIMARY KEY, " + "nome_usuario VARCHAR(255) NOT NULL, "
			...
			String createTableusreceitas = "CREATE TABLE IF NOT EXISTS receitas ("
					+ "id_receita INT NOT NULL AUTO_INCREMENT PRIMARY KEY, " + "id_usuario INT NOT NULL, "
					+ "data_receita VARCHAR(255) NOT NULL, " + "nome_receita VARCHAR(255) NOT NULL, "
